...
test_that("stretch_nltt_matrix: check hard newick, Cer2016 issue 83", {
  ...
  nltt_values <- nLTT::stretch_nltt_matrix(m = full_nltt_matrix,  dt = 0.1, step_type = "upper")
