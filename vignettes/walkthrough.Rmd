...
In order to provide some worked examples, we first generate two random phylogenetic trees, with similar parameter settings. Using the [TESS package](https://cran.r-project.org/web/packages/TESS/index.html) we simulate one tree with lambda = 0.4, and one tree with lambda = 0.25, both for 10 million years.
