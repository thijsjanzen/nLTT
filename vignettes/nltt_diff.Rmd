...
```{r}
#any(ape::branching.times(phylogeny_1) < 0.0) 
#any(ape::branching.times(phylogeny_2) < 0.0) 

nltt_stat <- nLTT::nltt_diff(phylogeny_1, phylogeny_2)
nltt_stat <- nLTT::nltt_diff_exact(phylogeny_1, phylogeny_2)
...
```{r}
# b_times <- ape::branching.times(phylogeny_1)
# lineages <- c(1:length(phylogeny_1$tip.label), length(phylogeny_1$tip.label))
# b_times2 <- ape::branching.times(phylogeny_2)
# lineages2 <- c(1:length(phylogeny_2$tip.label), length(phylogeny_2$tip.label))
