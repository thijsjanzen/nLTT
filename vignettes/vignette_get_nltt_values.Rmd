...
```{r}
t <- ribir::get_phylogeny_nltt_matrix(phylogeny1)
knitr::kable(t)
```
...
```{r}
t <- ribir::get_phylogeny_nltt_matrix(phylogeny2)
knitr::kable(t)
```
...
```{r}
t <- ribir::stretch_nltt_matrix(ribir::get_phylogeny_nltt_matrix(phylogeny1), dt = 0.20, step_type = "upper")
knitr::kable(t)
```
...
```{r}
t <- ribir::stretch_nltt_matrix(ribir::get_phylogeny_nltt_matrix(phylogeny2), dt = 0.20, step_type = "upper")
knitr::kable(t)
```
...
```{r}
t <- ribir::get_average_nltt_matrix(phylogenies, dt = 0.20)
knitr::kable(t)
```
...
```{r}
t <- ribir::get_nltt_values(c(phylogeny1,phylogeny2), dt = 0.2)
knitr::kable(t)
```
...
```{r}
t <- ribir::get_nltt_values(phylogenies, dt = 0.2)
knitr::kable(t)
```
